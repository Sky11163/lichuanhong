...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, disabled = props.disabled, className = props.className, size = props.size, href = props.href, children = props.children, restProps = __rest(props, ["btnType", "disabled", "className", "size", "href", "children"]);
